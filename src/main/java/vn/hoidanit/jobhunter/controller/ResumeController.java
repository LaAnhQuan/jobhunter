...
public class ResumeController {
    ...
    public ResponseEntity<ResCreResumeDTO> createNewResume(@Valid @RequestBody Resume resume)
    ...
    public ResponseEntity<ResUpResumeDTO> update(@RequestBody Resume resume) throws IdInvalidException {
        // check id exist
