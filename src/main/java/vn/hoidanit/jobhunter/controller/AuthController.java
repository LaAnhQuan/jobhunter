...
import static vn.hoidanit.jobhunter.mapper.UserMapper.toResCreUserDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        User currentUser = this.userService.getUserByRefreshTokenAndToken(refresh_token, email);
        if (currentUser == null) {
    ...
    public ResponseEntity<ResCreUserDTO> register(@Valid @RequestBody User postManUser) throws IdInvalidException {
        ...
        ResCreUserDTO ericUser = this.userService.handleCreateUser(postManUser);
